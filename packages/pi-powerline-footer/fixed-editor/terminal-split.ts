// biome-ignore-all lint/suspicious/noControlCharactersInRegex: Terminal split parsing intentionally matches control sequences.
// biome-ignore-all lint/suspicious/noExplicitAny: Pi TUI internals expose dynamic shapes here.
import {
  isKeyRelease,
  matchesKey,
  truncateToWidth,
...
export class TerminalSplitCompositor {
  ...
  private activeExtendedKeyboardMode(): ExtendedKeyboardMode | null {
    ...
    if (isGhosttyTerminal()) return 'modifyOtherKeys'
    return null
  }
