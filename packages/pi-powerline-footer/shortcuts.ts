// biome-ignore-all lint/suspicious/noControlCharactersInRegex: Shortcut matching intentionally uses terminal escape sequences.
...
export function matchesConfiguredShortcut(
  ...
  return matchesKey(data, shortcut as never)
}
