...
export const PiWorktreeConfigSchema = TypeObject(
  {
    ...
    onCreateDisplayOutputMaxLines: Optional(
      OnCreateDisplayOutputMaxLinesSchema,
    ),
    ...
    onCreateCmdDisplayPendingColor: Optional(
      OnCreateCmdDisplayPendingColorSchema,
    ),
    onCreateCmdDisplaySuccessColor: Optional(
      OnCreateCmdDisplaySuccessColorSchema,
    ),
